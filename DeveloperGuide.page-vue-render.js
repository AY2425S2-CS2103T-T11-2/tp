...
with(this){return _c('p',[_v("Some of CareBook features are adapted from the AddressBook-Level2 project created by the "),_c('a',{attrs:{"href":"https://se-education.org"}},[_v("SE-EDU initiative")]),_v(".\nAs such, CareBook contains some of the code and documentation from AddressBook-Level3.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to mark all students as absent by student ID.")])]),_v(" "),_c('li',[_c('p',[_v("CareBook updates the attendance record for every student as absent.")])]),_v(" "),_c('li',[_c('p',[_v("CareBook confirms that all students have been marked absent.")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. CareBook detects an empty list of students.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CareBook displays an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export all students information with a filename.")])]),_v(" "),_c('li',[_c('p',[_v("CareBook saves all students information into the directory where the CareBook application is located.")])])])}
},function anonymous(
) {
